...
public class Edificio {
	...
	} System.out.println("La puerta que tiene mas habitantes del edificio es la puerta " + puerta.charAt(PuertNum) + " con " + MayorDeTodo + " habitantes en el piso " + (PisoNum + 1) );
	}
}
